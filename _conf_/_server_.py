...
from _conf_._config_ import MYSQL_HOST, MYSQL_PORT, MYSQL_USER, MYSQL_PWD, MYSQL_CHARSET
from _conf_._config_ import MONGO_HOST, MONGO_PORT, MONGO_USER, MONGO_PWD
from _conf_._config_ import REDIS_HOST, REDIS_PORT, REDIS_PWD, REDIS_DB, REDIS_MAX_CONN
